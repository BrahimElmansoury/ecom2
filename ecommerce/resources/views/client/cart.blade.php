			...
			<div class="cart-page">
				<div class="cart-items">					
					<table>
						...
						<tbody>
						@php
							$totalPrice = 0; // Initialisation du total des prix
						@endphp
						
							@foreach ($products as $productitem)
							<tr id="nbr-of-product">
								...
								<td style="width: 20%;">
									...
									<br>
									<form action="{{route('remove-product',$productitem->id)}}" method="POST">
										@csrf
										@method('DELETE')
										<button  class="btn btn-go-to-paiement-x ">Supprimer</button>
									</form>
								</td>
								
								

								<td class="qty" style="width: 15%;" data-price="{{ $productitem->price }}">
									<h2 class="quantity-h2">chose Quantity</h2>	
									<div class="prev">-</div>
									<div class="next">+</div>
				...
				<div class="cart-summary">
					<div class="checkout-total">
						<h3>Cart Summary</h3>
						<ul>
							<li>Number of Products <span id="number-of-product"></span></li>
							<li>Number of items x 20</li>
							<hr>
							
						
							<form action="{{ route('products.checkout', $product->id) }}" method="get">
								@csrf
								<li id="cart-total">
								...
								<button class="btn-go-to-paiement" type="submit">Go to Checkout</button>
							</form>
